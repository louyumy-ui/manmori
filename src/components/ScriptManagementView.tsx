...
import { 
  Search, RotateCcw, ChevronDown, ChevronRight, 
  TrendingUp, Users, ShieldCheck, Info, Clock
} from 'lucide-react';
import { 
...
export const ScriptManagementView: React.FC = () => {
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-6 text-[10px]">
                    <span className="flex items-center gap-1.5 text-gray-400"><div className="w-2 h-2 rounded-full bg-orange-500" /> 无效号码</span>
